...
$(error Error! CRYPTO_TYPE variable must be set to $(NACL_CRYPTO_VAR) or to $(MBEDTLS_CRYPTO_VAR))
endif
endif
...
MBEDTLS_LIB=-lmbedtls -lmbedx509 -lmbedcrypto

INCLUDE_PATH=$(LIBSECURITY_DIR)/include/libsecurity/
LIBDIR=$(LIBSECURITY_DIR)/bin

INC1=-I$(HASH) -I. -I$(LIBSECURITY_DIR)/include -I$(MBEDTLS_INC_DIR)
LIB1=-L$(HASH)/hashtab -L$(MBEDTLS_LIB_DIR) -L$(LIBDIR)
...
ifeq ($(CRYPTO_TYPE),$(MBEDTLS_CRYPTO_VAR))
	...
	LIB_SEC=-lnacl
	INC=$(INC1) -I$(CRYPTO_PATH)
	LIB=$(LIB1) -L$(CRYPTO_LIB)
endif
